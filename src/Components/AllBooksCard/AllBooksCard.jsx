          ...
          <div className="shadow-lg my-10 rounded-md dark:border-2 dark:border-gray-500">
            ...
            <div className="p-7 space-y-3">
              ...
              <p className="font-bold text-black dark:text-gray-200">
                Short Description :{" "}
                <span className="font-medium text-sm text-black dark:text-gray-200 rounded-xl capitalize">
                  {short_description}
                </span>
              </p>
              <div className="flex flex-wrap font-bold justify-start gap-5  text-xs text-black">
                <p className="text-black dark:text-gray-200  text-sm font-medium leading-snug">
